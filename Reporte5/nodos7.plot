...
set arrow 33 from 3 , 2 to 3 , 3 nohead lw 2 
set arrow 34 from 3 , 3 to 3 , 2 nohead lw 2 
set arrow 35 from 3 , 3 to 4 , 3 nohead lw 2 
set arrow 36 from 4 , 3 to 3 , 3 nohead lw 2 
set arrow 37 from 4 , 3 to 4 , 4 nohead lw 2 
set arrow 38 from 4 , 4 to 4 , 3 nohead lw 2 
plot "grafica7.dat" using 1:2:3 with points pt 7 lc var ps 2  
quit()
